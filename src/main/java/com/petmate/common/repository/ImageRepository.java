...
public interface ImageRepository extends JpaRepository<ImageEntity, Long> {
    ...
    List<ImageEntity> findActiveImagesByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
    ...
    Optional<ImageEntity> findThumbnailByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);

    /**
     * 특정 참조 타입과 참조 ID로 첫 번째 이미지 조회 (썸네일이 없을 때 대체용)
     */
    @Query("SELECT i FROM ImageEntity i WHERE i.referenceType = :referenceType AND i.referenceId = :referenceId AND i.status = 'A' ORDER BY i.displayOrder ASC")
    Optional<ImageEntity> findFirstImageByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
    ...
    long countActiveImagesByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
    ...
    Integer findMaxDisplayOrderByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
    ...
    List<ImageEntity> findThumbnailsByReferenceIds(@Param("referenceType") String referenceType, @Param("referenceIds") List<String> referenceIds);
    ...
    void softDeleteAllByReference(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
    ...
    void clearAllThumbnails(@Param("referenceType") String referenceType, @Param("referenceId") String referenceId);
}